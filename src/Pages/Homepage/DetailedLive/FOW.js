    ...
    return (
        <div className="FOW-container">
           <div className="twoinnings">
            ...
            {
                    teamneeded && teamneeded.map((teemneed) => (
                        <div className="FOWbox">
                            {
                                teamneeded && teamneeded.map((team) => (
                                    <FOWInner fowteamwise={team.FoW} playerwithid={playerwithid}/>
                                ))
                            }
                        </div>
                    ))
